		...
		if (!interaction.memberPermissions.has(cmd.userPerms || []))
			return interaction.reply({
				embeds: [
					...
					.setDescription("My Apologies But You Do Not Have The Required Permissions To Use This Command.")
		...
		if (!interaction.guild.me.permissions.has(cmd.botPerms || []))
			return interaction.reply({
				embeds: [
					new MessageEmbed()
					.setTitle("Missing Permisssion")
					.setDescription("My Apologies But I Do Not Have The Required Permissions To Run This Command.")
